...
class DataCache:
    ...
    def checkCache(self,
        ...
        brand_cache = BrandCache(client=self.connection)
        ...
        serie_cache = SerieCache(client=self.connection)
        ...
        if index_attributes:
            ...
            attribute_cache = AttributeIndex(client=self.connection)
            ...
            attribute_cache = AttributeCache(client=self.connection)
    ...
    def triggerCache(self,
        ...
        ## category cache
        from cacheYour.categories.category import CategoryCache
        category_cache = CategoryCache(client=self.connection)
